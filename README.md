...
2. Open `firmware/multi-syringe/` as the project root.
3. Build and upload:
...
`firmware/multi-syringe/tools/` and is documented in
`firmware/multi-syringe/docs/recipes.md`. It validates recipe JSON using the
